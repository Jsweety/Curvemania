...
var angle = Math.PI;
var rx = 0,ry = 0;
var trail = [], trailLength, trailSplit, iStart, pos = [300,300,300,300,300,300,300,305,300,300,300,340,300,300,300,300,490,330,344,325];
...
function drawTrail() {
	trailLength = trail.indexOf(-1) != -1 ? (trail.indexOf(-1) < 128 ? trail.indexOf(-1) : 128) : 128;
...
function drawPbTrail() {
	...
	trailLength = trailSplit.indexOf(-1) != -1 ? (trailSplit.indexOf(-1) < 130 ? trailSplit.indexOf(-1) : 130) : 130;
    ctx.save();
    ctx.lineWidth = player.size;
    ctx.lineCap = "square";
...
function drawLevel(lvl) {
    if(lvl == 1) {
        ...
        ctx.beginPath();ctx.moveTo(2,203);ctx.lineTo(2,397);ctx.closePath();stroke("lime");
    ...
    if(lvl == 4) {
        ...
        ctx.stroke();
        lvlCollision = isPointInStroke();
        ctx.beginPath();ctx.moveTo(2,268);ctx.lineTo(2,332);ctx.closePath();stroke("lime");
        greenCollision = isPointInStroke();
    }
    if(lvl == 5) {
        ctx.beginPath();
    ...
    if(lvl == 6) {
        ...
        ctx.stroke();
        lvlCollision = isPointInStroke();
        ctx.beginPath();ctx.moveTo(2,205);ctx.lineTo(2,395);ctx.closePath();stroke("lime");
        greenCollision = isPointInStroke();
    }
    if(lvl == 7) {
        ctx.beginPath();
        ...
        ctx.stroke();
        lvlCollision = isPointInStroke();
        ctx.beginPath();ctx.moveTo(2,273);ctx.lineTo(2,327);ctx.closePath();stroke("lime");
        greenCollision = isPointInStroke();
    }
    if(lvl == 8) {
        ctx.beginPath();
    ...
    if(lvl == 11) {
        ...
        ctx.moveTo(0,270);ctx.lineTo(80,270);ctx.bezierCurveTo(80,50,375,50,375,230);ctx.lineTo(525,230);ctx.bezierCurveTo(525,50,820,50,820,270);
        ctx.lineTo(820,330);ctx.bezierCurveTo(820,550,525,550,525,370);ctx.lineTo(375,370);ctx.bezierCurveTo(375,550,80,550,80,330);ctx.lineTo(0,330);
        ...
        ctx.stroke();
        lvlCollision = isPointInStroke();
        ctx.beginPath();ctx.moveTo(225,498);ctx.lineTo(225,455);stroke("darkviolet");
        ctx.beginPath();ctx.moveTo(225,450);ctx.lineTo(225,400);stroke("darkviolet");if(player.x<225) teleporter(5,53); else teleporter(-5,53);
        ctx.beginPath();ctx.moveTo(770,270);ctx.lineTo(770,330);stroke("darkviolet");if(player.x>770) teleporter(82,0); else teleporter(98,0);
        ctx.beginPath();ctx.moveTo(860,272);ctx.lineTo(860,328);stroke("darkviolet");teleporter(-95,0);
        ctx.beginPath();ctx.moveTo(2,273);ctx.lineTo(2,327);ctx.closePath();stroke("lime");
        greenCollision = isPointInStroke();
    }
    if(lvl == 12) {
        ...
        ctx.moveTo(0,200);ctx.lineTo(100,200);ctx.lineTo(150,250);ctx.lineTo(280,120);ctx.lineTo(320,120);ctx.lineTo(390,250);ctx.lineTo(460,120);
        ...
        ctx.moveTo(0,400);ctx.lineTo(100,400);ctx.lineTo(150,350);ctx.lineTo(280,480);ctx.lineTo(320,480);ctx.lineTo(390,350);ctx.lineTo(460,480);
    ...
    if(lvl == 13) {
        ...
        ctx.moveTo(0,260);ctx.lineTo(150,210);ctx.lineTo(137,240);ctx.lineTo(180,280);ctx.lineTo(250,280);ctx.lineTo(250,180);
        ctx.bezierCurveTo(250,85,400,85,400,180);ctx.lineTo(400,250);
        ctx.moveTo(0,340);ctx.lineTo(150,390);ctx.lineTo(137,360);ctx.lineTo(180,320);ctx.lineTo(290,320);ctx.lineTo(290,180);
        ...
        ctx.moveTo(900,340);ctx.lineTo(750,390);ctx.lineTo(763,360);ctx.lineTo(720,320);ctx.lineTo(650,320);ctx.lineTo(650,420);
        ctx.bezierCurveTo(650,515,500,515,500,420);ctx.lineTo(500,350);
        ctx.moveTo(900,260);ctx.lineTo(750,210);ctx.lineTo(763,240);ctx.lineTo(720,280);ctx.lineTo(610,280);ctx.lineTo(610,420);
        ...
        ctx.beginPath();ctx.moveTo(502,352);ctx.lineTo(538,352);stroke("darkviolet");teleporter(-140,-110);
        ctx.beginPath();ctx.moveTo(2,263);ctx.lineTo(2,337);ctx.closePath();stroke("lime");
        greenCollision = isPointInStroke();
    }
    if(lvl == 14) {
        ctx.beginPath();
        ctx.moveTo(0,270);ctx.lineTo(20,270);ctx.lineTo(145,70);ctx.lineTo(265,70);ctx.lineTo(410,302);ctx.bezierCurveTo(410,352,490,352,490,302);
        ...
        ctx.moveTo(0,330);ctx.lineTo(40,330);ctx.lineTo(165,130);ctx.bezierCurveTo(165,80,245,80,245,130);ctx.bezierCurveTo(245,180,165,180,165,130);
    ...
    if(lvl == 15) {
        ctx.beginPath();
        ctx.moveTo(0,280);ctx.quadraticCurveTo(60,280,60,220);ctx.moveTo(0,320);ctx.quadraticCurveTo(100,320,100,220);
        ...
        ctx.stroke();
        lvlCollision = isPointInStroke();
        ctx.beginPath();ctx.moveTo(62,222);ctx.lineTo(98,222);stroke("darkviolet");
        ctx.beginPath();ctx.moveTo(702,578);ctx.lineTo(738,578);stroke("darkviolet");teleporter(-640,-350);
        ctx.beginPath();ctx.moveTo(642,482);ctx.lineTo(642,518);stroke("darkviolet");
        ctx.beginPath();ctx.moveTo(258,202);ctx.lineTo(258,238);stroke("darkviolet");teleporter(390,280);
        ctx.beginPath();ctx.moveTo(258,362);ctx.lineTo(258,398);stroke("darkviolet");
        ctx.beginPath();ctx.moveTo(622,182);ctx.lineTo(622,218);stroke("darkviolet");teleporter(-370,180);
        ctx.beginPath();ctx.moveTo(778,22);ctx.lineTo(778,58);stroke("darkviolet");
        ctx.beginPath();ctx.moveTo(362,282);ctx.lineTo(362,318);stroke("darkviolet");teleporter(410,-260);
        ctx.beginPath();ctx.moveTo(422,378);ctx.lineTo(458,378);stroke("darkviolet");
        ctx.beginPath();ctx.moveTo(112,422);ctx.lineTo(148,422);stroke("darkviolet");teleporter(310,-50);
        ctx.beginPath();ctx.moveTo(112,548);ctx.lineTo(148,548);stroke("darkviolet");
        ctx.beginPath();ctx.moveTo(422,452);ctx.lineTo(458,452);stroke("darkviolet");teleporter(-310,90);
        ctx.beginPath();ctx.moveTo(362,512);ctx.lineTo(362,548);stroke("darkviolet");
        ctx.beginPath();ctx.moveTo(298,112);ctx.lineTo(298,148);stroke("darkviolet");teleporter(70,400);
        ctx.beginPath();ctx.moveTo(202,52);ctx.lineTo(238,52);stroke("darkviolet");
        ctx.beginPath();ctx.moveTo(802,378);ctx.lineTo(838,378);stroke("darkviolet");teleporter(-600,-320);
        ctx.beginPath();ctx.moveTo(2,283);ctx.lineTo(2,317);ctx.closePath();stroke("lime");
        greenCollision = isPointInStroke();
    }
    if(lvl == 16) {
        ...
        ctx.fill();
        ctx.beginPath();
        ctx.moveTo(0,330);ctx.lineTo(480,330);ctx.lineTo(560,290);ctx.lineTo(640,330);ctx.lineTo(680,330);
		ctx.lineTo(760,370);ctx.lineTo(840,330);ctx.lineTo(900,330);
		ctx.moveTo(0,270);ctx.lineTo(480,270);ctx.lineTo(560,230);ctx.lineTo(640,270);ctx.lineTo(680,270);
    ...
    if(lvl == 17) {
        ...
        ctx.beginPath();
        ctx.moveTo(0,325);ctx.lineTo(60,325);ctx.lineTo(60,275);ctx.lineTo(325,275);ctx.lineTo(425,175);ctx.lineTo(425,70);
        ...
        ctx.moveTo(0,225);ctx.lineTo(295,225);ctx.lineTo(375,145);ctx.lineTo(375,100);ctx.lineTo(220,100);ctx.lineTo(220,150);
        ...
        ctx.beginPath();ctx.moveTo(2,227);ctx.lineTo(2,323);stroke("lime");
        greenCollision = isPointInStroke();
    }
    if(lvl == 18) {
        ctx.beginPath();
        ...
        ctx.moveTo(0,280);ctx.lineTo(150,280);ctx.lineTo(150,200);ctx.lineTo(105,155);ctx.lineTo(180,80);ctx.lineTo(255,155);ctx.lineTo(210,200);
        ...
        ctx.moveTo(0,320);ctx.lineTo(50,320);ctx.lineTo(50,400);ctx.lineTo(232,512);ctx.lineTo(360,512);ctx.lineTo(360,420);ctx.lineTo(315,420);
        ...
        ctx.stroke();
        lvlCollision = isPointInStroke();
        ctx.beginPath();ctx.moveTo(762,27);ctx.lineTo(798,27);stroke("darkviolet");
        ctx.beginPath();ctx.moveTo(812,398);ctx.lineTo(848,398);stroke("darkviolet");teleporter(-50,-367);
        ctx.beginPath();ctx.moveTo(2,283);ctx.lineTo(2,317);ctx.closePath();stroke("lime");
        greenCollision = isPointInStroke();
    }
    if(lvl == 19) {
        ...
        ctx.moveTo(0,280);ctx.lineTo(60,280);ctx.lineTo(60,120);ctx.lineTo(160,220);ctx.lineTo(160,150);ctx.bezierCurveTo(160,40,360,40,360,150);
        ...
        ctx.moveTo(0,320);ctx.lineTo(100,320);ctx.lineTo(100,240);ctx.moveTo(125,265);ctx.lineTo(160,300);ctx.lineTo(210,250);ctx.lineTo(210,150);
        ...
        ctx.beginPath();ctx.moveTo(552,272);ctx.lineTo(574,294);stroke("darkviolet");teleporter(-442,-33);
        ctx.beginPath();ctx.moveTo(2,283);ctx.lineTo(2,317);ctx.closePath();stroke("lime");
        greenCollision = isPointInStroke();
    }
    if(lvl == 20) {
        ctx.beginPath();
        ctx.moveTo(100,0);ctx.lineTo(100,50);ctx.lineTo(50,50);ctx.moveTo(0,100);ctx.lineTo(150,100);ctx.lineTo(150,50);ctx.lineTo(200,50);
        ...
        ctx.lineTo(50,500);ctx.lineTo(50,550);ctx.moveTo(0,450);ctx.lineTo(50,450);ctx.moveTo(100,600);ctx.lineTo(100,550);ctx.lineTo(200,550);
        ...
        ctx.lineTo(400,500);ctx.moveTo(250,550);ctx.lineTo(250,600);ctx.moveTo(100,400);ctx.lineTo(250,400);ctx.lineTo(250,450);ctx.lineTo(300,450);
        ...
        ctx.lineTo(350,50);ctx.moveTo(300,0);ctx.lineTo(300,50);ctx.moveTo(400,0);ctx.lineTo(400,50);ctx.lineTo(500,50);ctx.moveTo(550,50);
        ...
        ctx.lineTo(450,500);ctx.lineTo(500,500);ctx.lineTo(500,600);ctx.moveTo(850,100);ctx.lineTo(850,150);ctx.lineTo(800,150);ctx.lineTo(800,50);
        ctx.lineTo(600,50);ctx.lineTo(600,100);ctx.lineTo(650,100);ctx.lineTo(650,250);ctx.moveTo(850,50);ctx.lineTo(900,50);ctx.moveTo(700,50);
        ctx.lineTo(700,100);ctx.moveTo(650,150);ctx.lineTo(750,150);ctx.lineTo(750,100);ctx.moveTo(600,250);ctx.lineTo(600,200);ctx.lineTo(900,200);
        ...
        ctx.moveTo(850,400);ctx.lineTo(850,350);ctx.lineTo(900,350);ctx.moveTo(800,250);ctx.lineTo(700,250);ctx.moveTo(750,250);ctx.lineTo(750,500);
        ctx.lineTo(800,500);ctx.moveTo(750,300);ctx.lineTo(650,300);ctx.lineTo(650,550);ctx.moveTo(550,350);ctx.lineTo(650,350);
        ctx.moveTo(550,600);ctx.lineTo(550,500);ctx.lineTo(600,500);ctx.moveTo(700,600);ctx.lineTo(700,550);ctx.moveTo(750,600);ctx.lineTo(750,550);
        ctx.moveTo(750,450);ctx.lineTo(700,450);ctx.moveTo(650,400);ctx.lineTo(700,400);ctx.lineTo(700,350);
        ctx.stroke();
        lvlCollision = isPointInStroke();
        ctx.beginPath();ctx.moveTo(2,203);ctx.lineTo(2,347);ctx.closePath();stroke("lime");
        greenCollision = isPointInStroke();
    }
}
...
function drawSquare() {
    trail[0] = 896;trail[1] = pos[lvl-1];trail[2] = 900;trail[3] = pos[lvl-1];
    ctx.beginPath();
