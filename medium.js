...
function drawLevel(lvl) {
    ...
    if(lvl == 6) {
        ...
        ctx.stroke();
        lvlCollision = isPointInStroke();
        ctx.beginPath();ctx.moveTo(898,263);ctx.lineTo(898,337);ctx.closePath();stroke("lime");
        greenCollision = isPointInStroke();
    }
    if(lvl == 7) {
        ctx.beginPath();
    ...
    if(lvl == 8) {
        ...
        ctx.stroke();
        lvlCollision = isPointInStroke();
        ctx.beginPath();ctx.moveTo(898,273);ctx.lineTo(898,337);ctx.closePath();stroke("lime");
        greenCollision = isPointInStroke();
    }
    if(lvl == 9) {
        ctx.beginPath();
        ...
        ctx.stroke();
        lvlCollision = isPointInStroke();
        ctx.beginPath();ctx.moveTo(898,125);ctx.lineTo(898,475);ctx.closePath();stroke("lime");
        greenCollision = isPointInStroke();
    }
    if(lvl == 10) {
        ctx.beginPath();
        ...
        ctx.stroke();
        lvlCollision = isPointInStroke();
        ctx.beginPath();ctx.moveTo(898,283);ctx.lineTo(898,317);ctx.closePath();stroke("lime");
        greenCollision = isPointInStroke();
    }
    if(lvl == 11) {
        ctx.beginPath();
        ...
        ctx.stroke();
        lvlCollision = isPointInStroke();
        ctx.beginPath();ctx.moveTo(225,498);ctx.lineTo(225,455);stroke("darkviolet");teleporter(-5,-53);
        ctx.beginPath();ctx.moveTo(225,450);ctx.lineTo(225,400);stroke("darkviolet");teleporter(-5,53);
    ...
    if(lvl == 12) {
        ...
        ctx.beginPath();ctx.moveTo(898,321);ctx.lineTo(898,377);ctx.closePath();stroke("lime");
        greenCollision = isPointInStroke();
    }
    if(lvl == 13) {
    ...
    if(lvl == 15) {
        ...
        ctx.beginPath();ctx.moveTo(802,378);ctx.lineTo(838,378);stroke("darkviolet");
        ctx.beginPath();ctx.moveTo(898,283);ctx.lineTo(898,317);ctx.closePath();stroke("lime");
        greenCollision = isPointInStroke();
    }
    if(lvl == 16) {
    ...
    if(lvl == 17) {
        ...
        ctx.beginPath();ctx.moveTo(898,455);ctx.lineTo(898,531);stroke("lime");
        greenCollision = isPointInStroke();
    }
    if(lvl == 18) {
        ctx.beginPath();
        ...
        ctx.beginPath();ctx.moveTo(898,313);ctx.lineTo(898,347);ctx.closePath();stroke("lime");
        greenCollision = isPointInStroke();
    }
    if(lvl == 19) {
    	ctx.beginPath();
        ...
        ctx.beginPath();ctx.moveTo(898,341);ctx.lineTo(898,403);ctx.closePath();stroke("lime");
        greenCollision = isPointInStroke();
    }
    if(lvl == 20) {
        ctx.beginPath();
        ...
        ctx.stroke();
        lvlCollision = isPointInStroke();
        ctx.beginPath();ctx.moveTo(898,203);ctx.lineTo(898,347);ctx.closePath();stroke("lime");
        greenCollision = isPointInStroke();
    }
}
...
function modeCompletedMessage() {
	document.getElementById('canvas-message').style.display = "block";
	if(!speedrun) document.getElementById('canvas-message').innerHTML = "Medium Mode completed!";
	else document.getElementById('canvas-message').innerHTML = "Medium Mode completed!<br>Spacebar to restart level";
}
function message() {
