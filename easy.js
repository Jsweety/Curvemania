...
function drawTrail() {
	trailLength = trail.indexOf(-1) != -1 ? (trail.indexOf(-1) < 140 ? trail.indexOf(-1) : 140) : 140;
...
function drawPbTrail() {
	...
	trailLength = trailSplit.indexOf(-1) != -1 ? (trailSplit.indexOf(-1) < 142 ? trailSplit.indexOf(-1) : 142) : 142;
    ctx.save();
    ctx.lineWidth = player.size;
    ctx.lineCap = "square";
